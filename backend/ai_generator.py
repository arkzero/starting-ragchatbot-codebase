...
class ConversationState:
    ...
    def build_messages_for_round(self, round_number: int) -> List[Dict[str, Any]]:
        ...
        for round_data in self.rounds:
            messages.append({"role": "assistant", "content": round_data.assistant_message})
...
"""
    ...
    def _execute_round(self, conversation: ConversationState, round_number: int, 
    ...
    def _build_system_content_for_round(self, history: Optional[str], round_number: int) -> str:
        """
    ...
    def _execute_tools_with_error_handling(self, response, tool_manager) -> List[Dict[str, Any]]:
        """
    ...
    def _make_final_response_call(self, conversation: ConversationState) -> Any:
        ...
        system_content = self._build_system_content_for_round(conversation.history, len(conversation.rounds) + 1)
